...
export const setBookingsLoading = () =>
    ({ type: BOOKINGS_FETCH_LOAD }) as const;
...
export const fetchBookingsAsync =
    (filter: BookingsFilter = {}): AppThunk<Promise<void>> =>
    async (dispatch) => {
...
export const fetchUserBookingsAsync =
...
export const fetchBookingsByDateRangeAsync =
    (startDate: string, endDate: string): AppThunk<Promise<void>> =>
    async (dispatch) => {
        dispatch(setBookingsLoading());
...
export const createBookingAsync =
    (request: CreateBookingRequest): AppThunk<Promise<void>> =>
    async () => {
        await createBooking(request);
    };

export const updateBookingAsync =
    (id: string, request: UpdateBookingRequest): AppThunk<Promise<void>> =>
    async () => {
        await updateBooking(id, request);
    };

export const deleteBookingAsync =
