...
export const setUser = (user: GetUserResponse) =>
    ({ type: USER_FETCH, payload: user }) as const;
...
export const fetchUserAsync =
    (suppressUnauthorizedRedirect: boolean = false): AppThunk<Promise<void>> =>
    async (dispatch) => {
...
export const updateUserProfileAsync =
    (request: UpdateUserRequest): AppThunk<Promise<void>> =>
    async () => {
        await updateUserProfile(request);
    };

export const updateUserProfileImageAsync =
...
export const registerAsync =
    (data: AuthRegisterRequest): AppThunk<Promise<void>> =>
    async () => {
        await registerApi(data);
    };

export const loginAsync =
    (data: AuthLoginRequest): AppThunk<Promise<void>> =>
    async () => {
