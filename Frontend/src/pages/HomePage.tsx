...
import {createBookingAsync, fetchBookingsAsync, updateBookingAsync,} from '@/store/actions/bookingsActions';
            ...
            <div className="home-page__body">
                <div className="home-page__main">
                    <div className="home-page__filters-row">
                        ...
                        />
                        <AmenitiesFilter value={equipmentIds} onChange={setEquipmentIds} data={equipmentData}
                                         onFetch={handleFetchEquipment}/>
                    </div>
                    <div className="home-page__rooms-header">
                        <Text
                            className="home-page__rooms-title"
                        >
                            Переговорные
                        </Text>
                        <Link
                            className="home-page__rooms-link"
                            to="/rooms"
                        >
                            Просмотреть все
                        </Link>
